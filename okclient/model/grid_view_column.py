...
class GridViewColumn(
    ...
    @classmethod
    @property
    def valueType(cls) -> typing.Type['AttributeValueType']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        sourceAttributeName: typing.Union[sourceAttributeName, Unset] = unset,
        sourceAttributePath: typing.Union[sourceAttributePath, Unset] = unset,
        columnDescription: typing.Union[columnDescription, Unset] = unset,
