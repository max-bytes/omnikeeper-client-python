...
class SchemaForRequestBodyMultipartFormData(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        ContentDisposition: typing.Union[ContentDisposition, Unset] = unset,
...
_path = '/api/v{version}/ingest/insight-discovery/file'
_method = 'POST'
_auth = [
    'oauth2',
    'oauth2',
...
class IngestFileIngest(api_client.Api):
