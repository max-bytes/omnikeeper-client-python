...
> graphviz_dot_layer_centric(layer_ids_fromtoversion)
...
with okclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.graphviz_dot_layer_centric(
...
> graphviz_dot_trait_centric(layer_idsversion)
...
with okclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.graphviz_dot_trait_centric(
            path_params=path_params,
            query_params=query_params,
        )
    except okclient.ApiException as e:
